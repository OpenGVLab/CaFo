...
def run_ensemble_tip_dalle_adapter_F(cfg, 
    ...
    best_beta, best_alpha = best_beta, best_alpha = search_ensemble_hp(cfg, clip_cache_keys, clip_cache_values, clip_val_features, dino_cache_keys, dino_cache_values, dino_val_features, val_labels, clip_weights)
